...
export default class extends Binding {
	...
	onCreated() {
		...
		this.identifier.today.addEventListener("click", () => calendar.emit("setDate", { date: new Date() }))
		this.identifier.month.addEventListener("change", () => calendar.emit("setDate", { date: this.getCurrentMonthDate(), rebuild: true }))
